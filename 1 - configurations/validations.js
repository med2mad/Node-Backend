...
const querySanitizer = function () {
    return [query('name').trim().default(''), query('age').default(undefined), query('selectedPhotoName').trim().default(''), query('page').default(undefined), query('limit').default(undefined)];
}
