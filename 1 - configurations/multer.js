...
const d =  '/webProjects/AJAX School/vue front/public/uploads/'; //this is consedered "localhost/webprojects", without the initial slash (/) the adress is relative (webProjects folder gets created in this app)
